...
<body>
    ...
    <body class="bg-gray-100">
        <div class="min-h-screen flex justify-center items-center from-indigo-50 to-blue-100 px-4 py-6 font-sans">
            <div class="w-full justify-center items-center max-w-sm sm:max-w-md bg-white flex flex-col rounded-xl p-8 sm:p-10 shadow-xl border border-gray-200">
                ...
                <div class="text-center mb-8">
                    ...
                    <h3 class="font-extrabold text-md sm:text-3xl text-gray-800 mb-2">Halaman Login</h3>
                </div>

                <div class="flex justify-center mb-8">
                    <img src="{{ asset('images/main_logo.jpg') }}" alt="Logo" class="w-60 sm:w-48 object-contain">
                </div>




                <form action="{{ url('login_post') }}" method="POST" class="space-y-6">
                    @csrf
                ...
                <div class="mt-6 text-sm text-gray-600">
                    Belum punya akun?
                    <a href="{{ url('register') }}" class="text-blue-600 hover:underline font-medium">Daftar di sini</a>
                </div>
